...
export default function HeroSection() {
    ...
    const heroContentPhase: HeroContentPhase = heroPhase === "image" ? "image" : showVideoHeadline ? "video" : "hidden";
        ...
        <section className="relative w-full overflow-hidden">
            <div className="relative hidden w-full lg:block lg:h-[min(84svh,100vh)] lg:min-h-170 xl:h-[min(90svh,100vh)]">
                ...
                <div className="absolute inset-0">
                    <div className="absolute left-[clamp(48px,7vw,120px)] top-1/2 inline-flex w-[min(43vw,522px)] -translate-y-1/2 flex-col items-start justify-start gap-5 xl:gap-6">
                            ...
                            <AnimatePresence mode="wait" initial={false}>
                                {heroContentPhase === "video" ? (
                                    ...
                                    <motion.h1
                                        ...
                                        exit={{ opacity: 0, y: -32 }}
                                        transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] }}
                                        className="font-nimbus flex w-full flex-col justify-center text-3xl font-bold leading-tight text-[#2D5A27] xl:text-[40px] xl:leading-14"
                                    >
                                        {IMAGE_HEADLINE}
                                    </motion.h1>
                                ) : null}
                    ...
                    <div className="absolute bottom-[clamp(32px,6svh,72px)] left-[clamp(48px,7vw,120px)] flex w-[min(28vw,380px)] items-center justify-start gap-2.5">
                        <motion.div
            ...
            <div className="relative h-[min(75svh,100vh)] min-h-130 w-full overflow-hidden bg-[#004c0f] lg:hidden">
                ...
                <div className="absolute left-5 right-5 top-[52%] max-w-[min(88vw,350px)] -translate-y-1/2 sm:left-6 sm:right-6">
                    <AnimatedHeadline
