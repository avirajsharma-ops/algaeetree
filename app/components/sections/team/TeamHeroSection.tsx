...
export default function TeamHeroSection() {
    return (
        <section aria-labelledby="team-makers-heading" className="w-full bg-white">
            <div className="page-px py-4 lg:py-10 xl:py-14">
                <div className="mx-auto flex w-full max-w-[1488px] flex-col gap-6 overflow-hidden rounded-[24px] border-[0.5px] border-[#6c6c6c] bg-white pt-6 md:gap-8 md:pt-8 xl:gap-10 xl:pt-10">
                        ...
                        <div className="flex items-center gap-4 xl:hidden">
                            ...
                            <div className="flex min-w-0 flex-1 flex-col items-start justify-center gap-4">
                                <h1
                                    ...
                                    className="font-space-grotesk whitespace-nowrap text-[28px] font-medium leading-[32px] uppercase text-[#2d5a27] md:text-[36px] md:leading-[40px]"
                                >
                                    Team &amp; Makers
                                </h1>
                        ...
                        <div className="hidden xl:flex xl:items-center xl:justify-between xl:gap-8">
                            <div className="flex items-center gap-12">
                                ...
                                <h1
                                    ...
                                    className="font-space-grotesk text-[40px] font-medium leading-[56px] uppercase text-[#2d5a27]"
                                >
