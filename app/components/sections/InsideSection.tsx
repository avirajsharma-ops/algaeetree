        ...
        <section className="w-full overflow-hidden bg-white">
            <div className="page-px py-6 lg:hidden">
                <div className="flex flex-col items-center gap-6">
                    <h2 className="font-space-grotesk text-center text-[28px] uppercase leading-9.5 text-black">
            ...
            <div className="page-px hidden py-10 lg:block lg:py-[60px]">
                <div className="mx-auto flex w-full max-w-[1488px] flex-col items-center gap-10 lg:gap-[54px]">
                    <h2 className="font-space-grotesk flex w-full flex-col justify-center text-center text-[56px] leading-16 text-black">
