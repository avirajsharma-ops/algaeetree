                ...
                <div className="mx-auto w-full max-w-[1488px]">
                    ...
                    <div className="flex w-full items-start gap-6 lg:gap-12">
                        ...
                        <div className="flex flex-col gap-3 lg:gap-4">
                            <h2 className="font-space-grotesk text-[32px] font-medium uppercase leading-[1.1] text-black lg:text-[56px] lg:leading-[64px]">
                                How AlgaeTree Works
                            </h2>
                            <p className="font-nimbus max-w-[790px] text-[15px] leading-[22px] text-[#686868] lg:text-[20px] lg:leading-[28px]">
                                AlgaeTree works by drawing polluted urban air into the system through a controlled intake, where harmful particles like PM2.5 and PM10 are first filtered out. The cleaned air then enters the bioreactor chamber, where microalgae absorb CO₂ through photosynthesis and convert it into biomass.During this natural process, oxygen is generated as a byproduct. Finally, the system releases clean, oxygen-rich air back into the surrounding environment.
                            </p>
                        </div>
                    </div>
